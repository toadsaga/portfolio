...
const Skill = ({ type, exp, title, logo, icon, color, description, main = false }) => {
    ...
    return (
        <div
            ref={clickRef}
            className={`skill${main ? ' skill--main' : ''} skill--${type}${active ? ' skill--active' : ''}`}
            data-experience={exp}
            onClick={() => setActive(!active)}>
            <div className='skill__inner'>
                <div className='skill__title'>
                    {logo ? <div style={{ color: color }}>{logo}</div> : <FontAwesomeIcon icon={icon} style={{ color: color }} />}
                </div>
                <div className='skill__description'>{title}</div>
                <div className='skill__details'>
                    <div className='skill__details__inner'>{description}</div>
                </div>
            </div>
        </div>
    );
    ...
    return (
        <section className='skills'>
            <div className='periodic-table'>
                ...
                <Skill type='html' exp='20+' title='HTML' icon={faHtml5} color='#e34f26' description='blabla' main />
                <Skill type='css' exp='16+' title='CSS' icon={faCss3Alt} color='#1572B6' description='blabla' main />
                <Skill type='js' exp='14+' icon={faJs} color='#f7df1e' title='JS' description='blabla' main />

                <Skill type='html' exp='10+' logo={<Ssemantic />} title='Semantic' description='blabla' />
                <Skill type='css' exp='9+' logo={<Sass />} color='#CC6699' title='Sass' description='blabla' />
                <Skill type='css' exp='2' icon={faLess} color='#FFF' title='Less' description='blabla' />
                <Skill type='graphic' exp='20+' icon={faAdobe} color='#DA1F26' title='Adobe CC' description='blabla' />
                <Skill type='other' exp='10+' icon={faGitAlt} color='#F05032' title='Git' description='blabla' />
                <Skill type='other' exp='7+' logo={<Webpack />} title='Webpack' description='blabla' />
                <Skill type='js' exp='6+' icon={faNodeJs} color='#339933' title='NodeJS' description='blabla' />
                <Skill type='js' exp='3+' icon={faReact} color='#61DAFB' title='ReactJS' description='blabla' />

                <Skill type='html' exp='' logo={<A11y />} title='Accessibility' description='blabla' />
                <Skill type='css' exp='' logo={'B'} title='B.E.M.' description='blabla' />
                <Skill type='css' exp='' logo={<AtomicDesign />} title='Atomic Design' description='blabla' />
                <Skill type='php' exp='18+' icon={faPhp} title='php' description='blabla' main />
                <Skill type='other' exp='8+' icon={faNpm} color='#CB3837' title='npm' description='blabla' />
                <Skill type='other' exp='4+' icon={faYarn} color='#2C8EBB' title='Yarn' description='blabla' />
                <Skill type='js' exp='1' icon={faVuejs} color='#4FC08D' title='VueJS' description='blabla' />
                <Skill
                    type='js'
                    exp='10'
                    logo={
                        <svg
                            ...
                            data-prefix='fab'
                            data-icon='adobe'
                            className='svg-inline--fa fa-adobe fa-w-16 '
                            role='img'
                ...
                <Skill type='php' exp='16' icon={faWordpressSimple} color='#21759B' title='WordPress' description='blabla' />
                <Skill type='php' exp='1+' icon={faGrav} color='#221E1F' title='Grav CMS' description='blabla' />
                <Skill type='php' exp='6' icon={faDrupal} color='#0678BE' title='Drupal' description='blabla' />
                <Skill type='php' exp='3' icon={faMagento} color='#EE672F' title='Magento' description='blabla' />
            </div>
        </section>
    );
};
