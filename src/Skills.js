...
import { faHtml5, faCss3Alt, faJs, 
  ...
  import  {ReactComponent as Ssemantic}  from './assets/icons/semanticweb.svg';
  import  {ReactComponent as AtomicDesign}  from './assets/icons/moleculer.svg';
  import  {ReactComponent as A11y}  from './assets/icons/a11y.svg';
...
<div className="periodic-table">
  ...
  <div className="periodic-element main-skill skill--html" data-description="20+">
  ...
  <div className="periodic-element main-skill skill--css" data-description="16+">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faCss3Alt} style={{color:"#1572B6"}} /></div>
      <div className="description">CSS</div>
    </div>
  </div>
  <div className="periodic-element main-skill skill--js" data-description="14+">
    <div className="periodic-element-inner">
  ...
  <div className="periodic-element skill--html" data-description="10+">
    <div className="periodic-element-inner">
      <div className="title"><Ssemantic /></div>
      <div className="description">Semantic</div>
    </div>
  </div>
  <div className="periodic-element skill--css" data-description="9+">
    <div className="periodic-element-inner">
        <div className="title"><Sass style={{color: '#CC6699'}} /></div>
        {/* <div className="title"><FontAwesomeIcon icon={faSass} style={{color: '#CC6699'}}/></div> */}
      <div className="description">Sass</div>
    </div>
  </div>
  <div className="periodic-element skill--css" data-description="2">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faLess} style={{color: '#FFF'}} /></div>
      <div className="description">Less</div>
    </div>
</div>
<div className="periodic-element skill--graphic" data-description="20+">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faAdobe}  style={{color:"#DA1F26"}} /></div>
      <div className="description">Adobe CC</div>
    </div>
  </div>
  <div className="periodic-element skill--other" data-description="10+">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faGitAlt} style={{color: '#F05032'}} /></div>
      <div className="description">Git</div>
    </div>
  </div>
  <div className="periodic-element skill--other" data-description="7+">
    <div className="periodic-element-inner">
      <div className="title">
        <Webpack />
      </div>
  ...
  <div className="periodic-element skill--js" data-description="6+">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faNodeJs} style={{color: '#339933'}} /></div>
      <div className="description">NodeJS</div>
    </div>
  </div>
  <div className="periodic-element skill--js" data-description="3+">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faReact} style={{color: '#61DAFB'}} /></div>
      <div className="description">ReactJS</div>
    </div>
  </div>
  
  <div className="periodic-element skill--html" data-description="">
    <div className="periodic-element-inner">
      <div className="title"><A11y /></div>
      <div className="description">Accessibility</div>
    </div>
  </div>
  <div className="periodic-element skill--css" data-description="">
    <div className="periodic-element-inner">
  ...
  <div className="periodic-element skill--css" data-description="">
    <div className="periodic-element-inner">
      <div className="title"><AtomicDesign /></div>
      <div className="description">Atomic Design</div>
    </div>
  </div>


  <div className="periodic-element main-skill php-stuff" data-description="18+">
    <div className="periodic-element-inner">
    ...
    <div className="periodic-element skill--other" data-description="8+">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faNpm} style={{color: '#CB3837'}} /></div>
      <div className="description">npm</div>
    </div>
  </div>
  <div className="periodic-element skill--other" data-description="4+">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faYarn} style={{color: '#2C8EBB'}} /></div>
      <div className="description">Yarn</div>
    </div>
  </div>
  <div className="periodic-element skill--js" data-description="1">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faVuejs} style={{color: '#4FC08D'}} /></div>
      <div className="description">VueJS</div>
    </div>
  </div>
  <div className="periodic-element skill--js" data-description="10">
    <div className="periodic-element-inner">
      <div className="title">
  ...
  <div className="periodic-element php-stuff" data-description="16">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faWordpressSimple} style={{color: '#21759B'}}/></div>
      <div className="description">WordPress</div>
    </div>
  </div>
  <div className="periodic-element php-stuff" data-description="1+">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faGrav} style={{color: '#221E1F'}} /></div>
      <div className="description">Grav CMS</div>
    </div>
  </div>
  <div className="periodic-element php-stuff" data-description="6">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faDrupal} style={{color: '#0678BE'}}/></div>
      <div className="description">Drupal</div>
    </div>
  </div>
  <div className="periodic-element php-stuff" data-description="3">
    <div className="periodic-element-inner">
      <div className="title"><FontAwesomeIcon icon={faMagento} style={{color: '#EE672F'}} /></div>
